...
<div class="help-center-page">
    <div class="container">
        ...
        <!-- Help Categories -->
        <div class="help-categories" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: var(--space-6); margin-bottom: var(--space-8);">
            ...
            <div class="help-category card p-6">
                ...
                <div class="help-links" style="display: grid; gap: var(--space-2);">
                    <a href="/getting-started/" class="help-link" style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-3); border-radius: var(--radius-md); transition: background-color 0.2s; text-decoration: none; color: var(--color-primary);">
                        <span>📝</span>
            ...
            <div class="help-category card p-6">
                ...
                <div class="help-links" style="display: grid; gap: var(--space-2);">
                    <a href="/account-settings/" class="help-link" style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-3); border-radius: var(--radius-md); transition: background-color 0.2s; text-decoration: none; color: var(--color-primary);">
                        <span>⚙️</span>
            ...
            <div class="help-category card p-6">
                ...
                <div class="help-links" style="display: grid; gap: var(--space-2);">
                    <a href="/login-issues/" class="help-link" style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-3); border-radius: var(--radius-md); transition: background-color 0.2s; text-decoration: none; color: var(--color-primary);">
                        <span>🔑</span>
                        <span>Login Problems</span>
                    </a>
                    <a href="/data-issues/" class="help-link" style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-3); border-radius: var(--radius-md); transition: background-color 0.2s; text-decoration: none; color: var(--color-primary);">
                        <span>📡</span>
                        <span>Data Loading Issues</span>
                    </a>
                    <a href="/browser-support/" class="help-link" style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-3); border-radius: var(--radius-md); transition: background-color 0.2s; text-decoration: none; color: var(--color-primary);">
                        <span>🌐</span>
        ...
        <div class="card p-6 mb-6">
            ...
            <div class="popular-articles" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: var(--space-4);">
                <article class="popular-article" style="padding: var(--space-4); border: 1px solid var(--color-border); border-radius: var(--radius-md); transition: box-shadow 0.2s ease;">
