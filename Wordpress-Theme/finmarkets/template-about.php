...
<div class="about-page">
    <div class="container">
        ...
        <div class="card glass-card p-6 mb-6">
            <div style="display: grid; gap: var(--space-6);">
                <div class="mission-section">
                    <h2 style="color: var(--color-text); margin-bottom: var(--space-4);">Our Mission</h2>
                ...
                <div class="vision-section">
                    <h2 style="color: var(--color-text); margin-bottom: var(--space-4);">Our Vision</h2>
                    <p style="font-size: 1.125rem; line-height: 1.7; color: var(--color-text-muted);">
                ...
                <div class="values-section">
                    <h2 style="color: var(--color-text); margin-bottom: var(--space-4); display: flex; align-items: center; gap: var(--space-2);">What We Value</h2>
        ...
        <div class="card glass-card p-6">
            <h2 style="color: var(--color-text); margin-bottom: var(--space-4); text-align: center;">Join Our Community</h2>
