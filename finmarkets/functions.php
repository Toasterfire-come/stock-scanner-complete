...
function stock_scanner_scripts() {
    wp_enqueue_style('stock-scanner-style', get_stylesheet_uri(), array(), '1.4.1');
    wp_enqueue_script('chart-js', 'https://cdn.jsdelivr.net/npm/chart.js', array(), '3.9.1', true);
    wp_enqueue_script('stock-scanner-js', get_template_directory_uri() . '/js/theme.js', array('jquery'), '1.4.1', true);
