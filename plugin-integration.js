...
/* Additional CSS for notifications and styling */
...
.stock-scanner-notification.success {
    background: #00a32a;
}

.stock-scanner-notification.error {
    background: #d63638;
}
...
.stock-quote-result h4 {
    margin: 0 0 10px 0;
    font-size: 1.2em;
    color: #333;
}

.stock-quote-result .price {
    font-size: 1.8em;
    font-weight: bold;
    color: #2271b1;
    margin-bottom: 5px;
...
.stock-quote-result .change {
    font-size: 1.1em;
    font-weight: bold;
    margin-bottom: 10px;
}

.stock-quote-result .change.positive {
    color: #00a32a;
}

.stock-quote-result .change.negative {
    color: #d63638;
}

.stock-quote-result .volume,
.stock-quote-result .timestamp {
    font-size: 0.9em;
    color: #666;
    margin-bottom: 5px;
}
...
.recent-calls-list .endpoint {
    font-weight: bold;
    color: #2271b1;
}

.recent-calls-list .symbol {
    color: #333;
}

.recent-calls-list .timestamp {
    color: #666;
    font-size: 0.9em;
}
