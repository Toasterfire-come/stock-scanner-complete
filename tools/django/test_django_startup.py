...
print(f" Django setup issue: Celery Beat tables not found")
...
print(f" Celery Beat database error (expected before migrations)")
...
print(f" Management command issue (migration needed): {e}")
print(" This is normal before running migrations")
else:
