...
<main id="primary" class="site-main container mx-auto px-4 py-8">
  <nav class="text-sm text-muted-foreground mb-2" aria-label="Breadcrumbs">
    ...
    <span> / </span>
    <span aria-current="page"><?php esc_html_e('Scanner', 'retail-trade-scanner'); ?></span>
  </nav>
  
  <header class="mb-6">
    <h1 class="text-3xl font-bold leading-tight"><?php esc_html_e('Scanner', 'retail-trade-scanner'); ?></h1>
    <p class="mt-2 text-muted-foreground max-w-2xl"><?php esc_html_e('Filter and search stocks with advanced criteria', 'retail-trade-scanner'); ?></p>
  </header>
  ...
  <section class="py-6">
    <form id="rts-scanner-form" class="grid gap-3 md:grid-cols-6">
      ...
      <select class="border rounded px-3 py-2" name="exchange">
        <option value=""><?php esc_html_e('Any Exchange','retail-trade-scanner'); ?></option>
