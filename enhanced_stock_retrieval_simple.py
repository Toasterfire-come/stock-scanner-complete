#!/usr/bin/env python3
"""
Enhanced Stock Retrieval Script - SIMPLE VERSION (No Proxy Manager)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('enhanced_stock_retrieval_simple.log'),
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Enhanced Stock Retrieval Script - SIMPLE')
...
def main():
    ...
    print("ENHANCED STOCK RETRIEVAL SCRIPT - SIMPLE VERSION")
    print("=" * 60)
    ...
    if results:
        if args.output:
            ...
            filename = f"enhanced_stock_retrieval_simple_{mode}_{timestamp}.json"
