...
if __name__ == "__main__":
    ...
    if background_mode:
        print("[BACKGROUND] Starting Windows Stock Scanner in background mode...")
        print("[BACKGROUND] Process will run silently - check logs for updates")
        ...
        log_file = open('windows_scheduler_background.log', 'a')
        sys.stdout = log_file
        sys.stderr = log_file
