...
urlpatterns = [
    ...
    # Referral program
    path('referrals/link', referral_api.get_referral_link_api, name='referral_link'),
    path('referrals/invite', referral_api.create_referral_invite_api, name='referral_invite'),
    path('referrals/summary', referral_api.referral_summary_api, name='referral_summary'),
    path('referrals/webhook/mark-paid', referral_api.referral_mark_paid_webhook_api, name='referral_mark_paid'),
]
