...
print("\n" + "=" * 80)
print("GOLD PLAN - MONTHLY")
print("=" * 80)
gold_monthly = get_plan_pricing_with_tax('gold', 'monthly')
print(f"Plan: {gold_monthly['plan'].upper()}")
print(f"Billing Cycle: {gold_monthly['billing_cycle']}")
print(f"Subtotal: {format_currency(gold_monthly['subtotal'])}")
print(f"Tax (7%): {format_currency(gold_monthly['tax'])}")
print(f"Total: {format_currency(gold_monthly['total'])}")
...
print("\n" + "=" * 80)
print("GOLD PLAN - YEARLY")
print("=" * 80)
gold_yearly = get_plan_pricing_with_tax('gold', 'yearly')
print(f"Plan: {gold_yearly['plan'].upper()}")
print(f"Billing Cycle: {gold_yearly['billing_cycle']}")
print(f"Subtotal: {format_currency(gold_yearly['subtotal'])}")
print(f"Tax (7%): {format_currency(gold_yearly['tax'])}")
print(f"Total: {format_currency(gold_yearly['total'])}")
print(f"Monthly Savings: {format_currency((gold_monthly['total'] * 12) - gold_yearly['total'])}")
...
print("✅ Yearly plans show cost savings")
