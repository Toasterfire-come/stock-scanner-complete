...
from . import views
from . import paypal_subscriptions

app_name = 'billing'

urlpatterns = [
    # PayPal order management (one-time payments)
    ...
    path('subscription/create/', paypal_subscriptions.create_subscription, name='create_subscription'),
    path('subscription/cancel/', paypal_subscriptions.cancel_subscription, name='cancel_subscription'),
    path('subscription/status/', paypal_subscriptions.get_subscription_status, name='subscription_status'),
    ...
    # Webhooks
    path('webhooks/paypal/', paypal_subscriptions.paypal_webhook, name='paypal_webhook'),  # Updated to use subscription webhook handler
]
