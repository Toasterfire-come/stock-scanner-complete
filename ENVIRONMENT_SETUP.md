...
The pricing has been updated to reflect current market rates:

```bash
# Bronze Plan - Entry Level
BRONZE_MONTHLY_PRICE=29.99
BRONZE_QUARTERLY_PRICE=79.99
BRONZE_ANNUAL_PRICE=299.99

# Silver Plan - Popular Choice
SILVER_MONTHLY_PRICE=49.99
SILVER_QUARTERLY_PRICE=134.99
SILVER_ANNUAL_PRICE=499.99

# Gold Plan - Professional
GOLD_MONTHLY_PRICE=89.99
GOLD_QUARTERLY_PRICE=239.99
GOLD_ANNUAL_PRICE=899.99

# Premium Plan - Enterprise
PREMIUM_MONTHLY_PRICE=149.99
PREMIUM_QUARTERLY_PRICE=399.99
PREMIUM_ANNUAL_PRICE=1499.99
```
