    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50/50 to-indigo-100/50">
      ...
      <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-gray-700 mb-6">We collaborate with financial publishers, communities, and data providers.</p>

          <div className="bg-white border rounded-xl p-6 space-y-3">
            <div>
              <h2 className="text-2xl font-semibold text-gray-900">Opportunities</h2>
              <ul className="list-disc pl-6 text-gray-700 mt-2 space-y-1">
                <li>Content partnerships and backlinks</li>
                <li>Embeddable market data widgets</li>
                <li>Affiliate and referral programs</li>
                <li>API integrations and research tools</li>
              </ul>
            </div>
            <div>
