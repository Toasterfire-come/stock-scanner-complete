  ...
  const plans = [
    {
      ...
      features: [
        ...
        `Near real-time alerts (50 alerts/mo) with sub-${reliability.apiP95LatencyMs}ms delivery`,
        "Chart timeframes: 15m, 30m, 1H, 1D, 1W, 1M",
        "2 Watchlists",
        "No portfolios",
    ...
    },
    {
      ...
      features: [
        ...
        "ALL chart timeframes: 1m, 5m, 15m, 30m, 1H, 4H, 1D, 1W, 1M",
        "Custom watchlists (10)",
        `Near real-time alerts (100 alerts/mo) with ${formatPercent(outcomes.averageDrawdownReductionPercent)} drawdown reduction`,
        "Portfolio tracking (1 portfolio)",
        `Priority email support (${reliability.supportFirstResponseMinutes} min median reply)`,
        "Advanced charting with 8 technical indicators",
    ...
    },
    {
      ...
      features: [
        "Unlimited API calls",
        "ALL chart timeframes: 1m, 5m, 15m, 30m, 1H, 4H, 1D, 1W, 1M",
        "All premium features + AI Backtesting (5/month)",
        "Unlimited alerts with sub-500ms delivery",
        "Full REST API access",
        `Strategic support for ${formatNumber(enterprise.enterpriseClients)} enterprise accounts`,
        "Full charting suite with Heikin-Ashi",
