  ...
  const features = [
    {
      ...
      description: `Screen 7,000+ NYSE and NASDAQ stocks with 14 technical and fundamental criteria including real-time data analysis.`,
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-blue-600 mb-2">
                  {Number(platformStats?.nyse_stocks || 7000).toLocaleString()}
                </div>
