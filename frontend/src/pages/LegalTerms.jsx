      ...
      <div className="container-enhanced py-8 max-w-4xl">
        ...
        <Card>
          <CardContent className="prose prose-lg max-w-none p-8 dark:prose-invert">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">3. User Account</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">4. Acceptable Use</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">5. Financial Data Disclaimer</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">6. Investment Disclaimer</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">7. Subscription and Billing</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">8. API Usage Limits</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">10. Termination</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              We may terminate or suspend your account immediately, without prior notice, if you breach these Terms of Service.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">11. Changes to Terms</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-6 mb-8">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700 dark:text-gray-300 ml-2">Retail Trade Scanner, Legal Department</span>
              </div>
            </div>
          </CardContent>
        </Card>
