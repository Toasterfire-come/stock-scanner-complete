...
if (!BASE) { console.warn("REACT_APP_BACKEND_URL is not set. API calls will fail."); }
...
export function getMarketStats() { return api.get("/market-stats/"); }
export function getStatistics() { return api.get("/statistics/"); }
...
export function subscribeEmail(payload) { return api.post("/subscription/", payload); }
...
// Stocks & screener
export function getStocks(params) { return api.get("/stocks/", { params }); }