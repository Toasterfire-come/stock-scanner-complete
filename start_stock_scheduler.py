...
ExecStart={self.venv_python} {self.manage_py} update_stocks_yfinance --startup --limit 3500
Restart=always
RestartSec=30
...
"{self.venv_python}" "{self.manage_py}" update_stocks_yfinance --startup --limit 3500
"""
