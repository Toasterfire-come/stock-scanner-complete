<?php
/**
 * Home Page Template (blog home fallback) -> Uses front-page style content
 * This ensures a proper home.php exists even if a static page isn't set.
 */
get_header(); ?>
  ...
  <div class="container">
    <section class="page-header">
      ...
      <div class="cta-buttons">
        <a class="btn btn-primary" href="<?php echo esc_url(home_url('/stock-dashboard/')); ?>"><span><?php esc_html_e('Open Dashboard', 'retail-trade-scanner'); ?></span></a>
        <a class="btn btn-gold" href="<?php echo esc_url(home_url('/membership-plans/')); ?>"><span><?php esc_html_e('See Plans', 'retail-trade-scanner'); ?></span></a>
      </div>
    </section>
    ...
    <section class="grid-3">
      <div class="feature-card">
        ...
        <p><?php esc_html_e('Use powerful widgets on any page with shortcodes.', 'retail-trade-scanner'); ?></p>
      ...
      <div class="feature-card">
        ...
        <p><?php esc_html_e('Track major indices at a glance.', 'retail-trade-scanner'); ?></p>
      ...
      <div class="feature-card">
        ...
        <p><?php esc_html_e('Plan-aware UI with premium badges.', 'retail-trade-scanner'); ?></p>
