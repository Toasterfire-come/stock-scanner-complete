        ...
        <div class="container">
            ...
            <div class="features-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: var(--space-6);">
                <div class="feature-card card p-6" style="text-align: center; transition: transform 0.2s ease, box-shadow 0.2s ease;">
                    <div class="feature-icon" style="font-size: 1.2rem; margin-bottom: var(--space-4); padding: var(--space-4); background: linear-gradient(135deg, var(--color-primary) 0%, #1d4ed8 100%); border-radius: 50%; color: white; display: inline-flex; align-items: center; justify-content: center; width: 80px; height: 80px; font-weight: bold;">DATA</div>
                ...
                <div class="feature-card card p-6" style="text-align: center; transition: transform 0.2s ease, box-shadow 0.2s ease;">
                    <div class="feature-icon" style="font-size: 1.2rem; margin-bottom: var(--space-4); padding: var(--space-4); background: linear-gradient(135deg, var(--color-primary) 0%, #1d4ed8 100%); border-radius: 50%; color: white; display: inline-flex; align-items: center; justify-content: center; width: 80px; height: 80px; font-weight: bold;">SCAN</div>
                ...
                <div class="feature-card card p-6" style="text-align: center; transition: transform 0.2s ease, box-shadow 0.2s ease;">
                    <div class="feature-icon" style="font-size: 1.2rem; margin-bottom: var(--space-4); padding: var(--space-4); background: linear-gradient(135deg, var(--color-primary) 0%, #1d4ed8 100%); border-radius: 50%; color: white; display: inline-flex; align-items: center; justify-content: center; width: 80px; height: 80px; font-weight: bold;">TRACK</div>
                ...
                <div class="feature-card card p-6" style="text-align: center; transition: transform 0.2s ease, box-shadow 0.2s ease;">
                    <div class="feature-icon" style="font-size: 1.2rem; margin-bottom: var(--space-4); padding: var(--space-4); background: linear-gradient(135deg, var(--color-primary) 0%, #1d4ed8 100%); border-radius: 50%; color: white; display: inline-flex; align-items: center; justify-content: center; width: 80px; height: 80px; font-weight: bold;">FAST</div>
...
.trial-promo-section .trial-promo {
