 ...
 */
class RetailTradeScanner_Nav_Walker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
        ...
        if ($has_children) {
            ...
            $output .= '<button class="submenu-toggle" aria-controls="' . esc_attr($toggle_id) . '" aria-expanded="false" aria-label="' . 
                       sprintf(
                           /* translators: %s: menu item title */
                           esc_attr__('Toggle submenu for %s', 'retail-trade-scanner'), 
                           esc_attr($title)
                       ) . '">'
